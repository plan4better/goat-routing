...
DROP FUNCTION IF EXISTS temporal.fill_polygon_h3_10;
CREATE OR REPLACE FUNCTION temporal.fill_polygon_h3_10(geom geometry)
...
BEGIN
    ...
    SELECT sub.h3_index, to_short_h3_10(sub.h3_index::bigint) AS h3_short,
